...
VALUES
    (3, 4, 'От пыли почистили, но теперь везде следы от щетки, а еще и всю термопасту зачем-то срезали'),
    (5, 5, 'Огромное спасибо за восстановление фотографий со свадьбы тёти Наташи из Анапы в 2013 году');
