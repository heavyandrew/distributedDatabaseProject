...
VALUES
    ...
    ('Лебедев',  'Константин', 'Игоревич',    '89985552211', 'konstantin.lebedyev@example.com', 6, 1, '2021-08-15', NULL),
...
VALUES
    ...
    (5, 'Western Digital My Passport',     6, 5500.25,  'Портативный внешний жесткий диск на 2 ТБ, предлагающий отличное решение для хранения данных на ходу.'),
    (4, 'MSI GeForce GTX 1660 Super', 8, 29999.25, 'Игровая видеокарта с хорошей производительностью в современных играх и поддержкой технологий NVIDIA.'),
